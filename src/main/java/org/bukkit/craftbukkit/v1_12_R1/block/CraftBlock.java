...
public class CraftBlock implements Block {
    ...
    public BlockState getState() {
        ...
        } else if (material == Material.BURNING_FURNACE || material == Material.FURNACE) {
        ...
        } else if (material == Material.BANNER || material == Material.WALL_BANNER || material == Material.STANDING_BANNER) {
            return new CraftBanner(this);
        } else if (material == Material.FLOWER_POT) {
            return new CraftFlowerPot(this);
        } else if (material == Material.STRUCTURE_BLOCK) {
            return new CraftStructureBlock(this);
        } else if (material == Material.WHITE_SHULKER_BOX || material == Material.ORANGE_SHULKER_BOX || material == Material.MAGENTA_SHULKER_BOX || material == Material.LIGHT_BLUE_SHULKER_BOX || material == Material.YELLOW_SHULKER_BOX || material == Material.LIME_SHULKER_BOX || material == Material.PINK_SHULKER_BOX || material == Material.GRAY_SHULKER_BOX || material == Material.SILVER_SHULKER_BOX || material == Material.CYAN_SHULKER_BOX || material == Material.PURPLE_SHULKER_BOX || material == Material.BLUE_SHULKER_BOX || material == Material.BROWN_SHULKER_BOX || material == Material.GREEN_SHULKER_BOX || material == Material.RED_SHULKER_BOX || material == Material.BLACK_SHULKER_BOX) {
            return new CraftShulkerBox(this);
        } else if (material == Material.ENCHANTMENT_TABLE) {
            if (CraftCustomContainer.QuarkMatrixEnchantingTable.isEnable() && CraftCustomContainer.QuarkMatrixEnchantingTable.isTileMatrixEnchanterBase(chunk.getCraftWorld().getTileEntityAt(x, y, z)))
                return new CraftCustomContainer.QuarkMatrixEnchantingTable(this); // CatServer - Fix Quark replace vanilla te cause ClassCastException
        ...
        } else if (material == Material.REDSTONE_COMPARATOR_OFF || material == Material.REDSTONE_COMPARATOR_ON) {
    ...
    public static Biome biomeBaseToBiome(net.minecraft.world.biome.Biome base) {
        ...
        return Biome.valueOf(net.minecraft.world.biome.Biome.REGISTRY.getNameForObject(base).getPath().toUpperCase(java.util.Locale.ENGLISH));
    }
    ...
    public PistonMoveReaction getPistonMoveReaction() {
        return PistonMoveReaction.getById(getNMSBlock().getPushReaction(getNMSBlock().getStateFromMeta(getData())).ordinal());
    }
